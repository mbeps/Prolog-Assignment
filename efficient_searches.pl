 ...
 * If the function is able to find a solution in the new list, it returns the solution. 
 * If not, the function recursively calls itself with the updated path and list.
*/
